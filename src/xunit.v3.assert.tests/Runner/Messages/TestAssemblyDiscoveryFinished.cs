...
namespace Xunit
{
    ...
    /// </summary>
    public class TestAssemblyDiscoveryFinished : ITestAssemblyDiscoveryFinished, IMessageSinkMessage
    {
        /// <summary>
        ...
        IXunitProjectAssembly ITestAssemblyDiscoveryFinished.Assembly => Assembly;
    }
}
