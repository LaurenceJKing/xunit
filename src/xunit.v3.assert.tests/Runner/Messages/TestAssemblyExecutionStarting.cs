...
namespace Xunit
{
    ...
    /// </summary>
    public class TestAssemblyExecutionStarting : ITestAssemblyExecutionStarting, IMessageSinkMessage
    {
        /// <summary>
        ...
        IXunitProjectAssembly ITestAssemblyExecutionStarting.Assembly => Assembly;
    }
}
